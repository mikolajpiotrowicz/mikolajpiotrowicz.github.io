...
$(document).ready(() => {
    $('.about-me-trigger').click(() => {
        $('.container').append('<section class="about-me fadeInDownBig about-animation-setup">\n' +
            '        <h2 class="about-me__title">Who I am?</h2>\n' +
            '        <p>My name is Mikołaj Piotrowicz</p>\n' +
            '    </section>');
    })
});
...
function render() {
    ...
    let positionLocation = gl.getAttribLocation(program, "a_position"); // do stuff for those vertex's
